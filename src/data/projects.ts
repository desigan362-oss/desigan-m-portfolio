import beezHero from "@/assets/beez-haircare-hero-no-brand.jpg";
...
import annaiMiraHero from "@/assets/annai-mira-hero-no-brand.jpg";
import jayanthiBakeryHero from "@/assets/jayanthi-bakery-hero-no-brand.jpg";
...
import mapisClinicHero from "@/assets/mapis-clinic-hero-no-brand.jpg";
...
import leeDigitalArtsHero from "@/assets/lee-digital-arts-hero-clean.png";
...
import karTowersHero from "@/assets/kar-towers-hero-no-brand.jpg";
...
import primePublicSchoolHero from "@/assets/prime-public-school-hero-no-brand.jpg";
